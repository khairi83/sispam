...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO jenis (jenis, komen) VALUES (%s, %s)",
  ...
  $insertGoTo = "AsetSenaraiJenis.php";
  if (isset($_SERVER['QUERY_STRING'])) {
 ...
 ?>
<?php $pageTitle="Tambah Jenis Aset"; ?>
<?php include('lain/pengepala.php'); ?>
<!-- Pengesahan untuk borang Jenis Aset -->
...
function validateForm()
{
	...
	if (a==null || a=="")
	{
	alert("Sila masukkan data Jenis Aset");
		return false;	
...
<form method="post" name="form1" onsubmit="return validateForm()" action="<?php echo $editFormAction; ?>">
  <fieldset>
  <legend>Tambah Jenis Aset </legend>
  <p>
    <label for="Vendor">Jenis Aset</label>
    <input type="text" name="jenis" value="" size="32">
  </p>
  <p>
